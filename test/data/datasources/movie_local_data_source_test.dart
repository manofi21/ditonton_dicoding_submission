...
void main() {
  ...
  group('Get Movie Detail By Id', () {
    ...
    test('should return Movie Detail Table when data is found', () async {
      // arrange
      when(mockDatabaseHelper.getItemByIdAndType(tId, ItemType.movie))
    ...
    test('should return null when data is not found', () async {
      // arrange
      when(mockDatabaseHelper.getItemByIdAndType(tId, ItemType.movie)).thenAnswer((_) async => null);
      // act
      final result = await dataSource.getMovieById(tId);
      // assert
      expect(result, null);
  ...
  group('get watchlist movies', () {
    test('should return list of MovieTable from database', () async {
      // arrange
      when(mockDatabaseHelper.getWatchlist(ItemType.movie.toString()))
          .thenAnswer((_) async => [testMovieMap]);
      // act
